...
class Mail {
	...
	//public $smtp_hostname = 'smtp.e-interview.co.za';
	//public $smtp_username = 'info@e-interview.co.za';
	//public $smtp_password = '06Iz14xLkz30wu5H6dhA';
	

	public $smtp_hostname = 'ssl://smtp.googlemail.com';
	public $smtp_username = 'elecinterview@gmail.com';
	public $smtp_password = 'E-inter@123';

	/*
	public $smtp_hostname = 'email-smtp.eu-west-1.amazonaws.com';
	public $smtp_username = 'AKIASXA2QT2H2W23EFT3';
	public $smtp_password = 'BOc48zpxzLHqjdT/oBQpGtcEqCSqyYvq7z55fiJWt78D';
	*/
	...
	public function send() {
		...
		$config = Array(
		    ...
		    'smtp_port' => 465,
		    'smtp_user' => 'AKIASXA2QT2HW2S62AVJ',
		    'smtp_pass' => 'BG24gH/y0OYO9On10oNnjGojVBN5Glrhg3WxIb6ENkZ0',
		    'mailtype'  => 'html', 
		    'charset'   => 'utf-8',
		    'newline' 	=> "\r\n",
		    'mailtype'	=> 'html'
		...
		$CI->email->from('info@e-interview.co.za','e-interview');
		$CI->email->to($to);		
