...
class Candidate_dashboard extends CI_Controller {
	...
	function __construct() {
        parent::__construct();
		$this->load->model(array('auth_model','project_model','job_profile_model','candidate_model','account_manager_model','manager_model','interview_model'));
        if(!$this->checkLogin()){
        	redirect(base_url());
        }
    }
	...
	public function index(){
		...
		$data['heading_title'] = $this->lang->line('heading_title_welcome');
		$data['title'] = $this->lang->line('heading_title_welcome');
		$data['text_heading_dashboard'] = $this->lang->line('heading_title_welcome');
	...
	public function my_interview(){
		...
		$data['heading_title'] = $this->lang->line('text_my_interview');
		$data['title'] = $this->lang->line('text_my_interview');
		$data['text_heading_dashboard'] = $this->lang->line('text_my_interview');
		...
		$data['action'] = base_url().'candidate_dashboard/my_interview';
		...
		$data['interview_status'] = $this->interview_model->getInterviewStatus($this->session->userdata['interview_user']);
		$this->app->view('candidate_interview',$data);
	}
