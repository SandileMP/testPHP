...
class Interview_login extends CI_Controller {
	...
	function __construct() {
		...
		$this->load->model(array('interview_model', 'candidate_model', 'project_model', 'auth_model', 'credit_model', 'account_manager_model'));
	...
	public function register() {
		...
		// $mclient_id = $this->account_manager_model->getAuthHr($client_auth_id)['profile_id'];
		// $mclient = $this->account_manager_model->getHr($mclient_id);
		...
		*/
		$this->load->view('interview/interview_signup2', $data);
	}
