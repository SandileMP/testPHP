						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									...
									<td><button type="button" name="project_link_model" data-text="<?= base_url() . 'interview/'.$project['project_code'] ?>" value="<?= $project['project_id'] ?>" class="btn btn-primary project_link_model"><i class="fa fa-magic"></i></button></td>
									<td>
...
$('.project_link_model').click(function(){
	...
	$('#project_link_model .modal-body button').attr('value',id);
