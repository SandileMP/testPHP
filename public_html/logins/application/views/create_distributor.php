		...
		<div class="container-fluid">
			<div class="panel panel-headline">
				...
				<div class="panel-body">
					<label><?=$entry_distributor?></label>
					<input type="text" name="distributor" class="form-control" value="<?=$distributor?>" placeholder="<?=$entry_distributor?>" />
					<?php if ($error_distributor) {?>
					<div class="text-danger"><?=$error_distributor?></div>
					<?php }?>
					<br>
