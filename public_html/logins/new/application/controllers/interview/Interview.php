...
class Interview extends CI_Controller {
    ...
    public function index(){
		...
		$data['text_start_interview_heading1'] = $this->lang->line('text_start_interview_heading1').$candidate_details->candidate_name;
		...
		$data['button_start_interview'] = $this->lang->line('button_start_interview');
		$data['button_invited'] = $this->lang->line('button_invited');

		$data['start_interview'] = base_url().'start';
	...
	public function start(){
		...
		$data['text_start_interview_instructions2'] = $this->lang->line('text_start_interview_instructions2');
		...
		$this->app_interview->view('interview/interview_start',$data);
	}
	...
	public function cancelled(){
		...
		$data['text_interview_question'] = $this->lang->line('text_interview_question');
		$data['text_interview_question_expire'] = $this->lang->line('text_interview_question_expire');
		$data['status_text'] = 'Your Interview Has Cancelled!!, Contact Admin if you any query.';
