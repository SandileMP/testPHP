						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									<td>
									<label class="fancy-checkbox">
										<input type="checkbox" name="removecheck[]" value="<?= $hr->hr_id ?>" />
										<span></span>
									</label>
									</td>
									<td><?= $hr->client ?></td>
									...
									<td>
										<a href="<?= $edit ?>/<?= $hr->hr_id ?>" class="btn btn-info" data-toggle="tooltip" title="<?= $button_edit ?>"><i class="fa fa-pencil"></i></a>
										<a href="<?= $remove ?>/<?= $hr->hr_id ?>" class="btn btn-danger remove" data-toggle="tooltip" title="<?= $button_remove ?>"><i class="fa fa-trash"></i></a>
									</td>
								</tr>
								<?php } ?>
								<?php } else { ?>
