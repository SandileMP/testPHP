		...
		<div class="container-fluid">
			<div class="panel panel-headline">
				...
				<div class="panel-body">
					...
					<label><?= $entry_project_description ?></label>
					<textarea name="project_description" placeholder="<?= $entry_project_description ?>" rows="5" class="form-control"><?= $project_description ?></textarea>
					<?php if($error_project_description) { ?>
					<div class="text-danger"><?= $error_project_description ?></div>
					<?php } ?>
					<br>
					...
					<?php } ?>
					<br>
					<?php if($this->uri->segments[1] == 'project' && $this->uri->segments[2] != 'edit') { ?>
					...
					<div class="candidate_list">
						...
						<div class="row candidate_list_row" style="margin-bottom:5px;">
							<div class="col-sm-6">
								<input type="text" name="candidate[<?= $key ?>][name]" value="<?= $value['candidate_name'] ?>" placeholder="<?= $entry_candidate_name ?>" class="form-control" disabled>
							</div>
							<div class="col-sm-5">
								<input type="email" name="candidate[<?= $key ?>][email]" value="<?= $value['candidate_email'] ?>" placeholder="<?= $entry_candidate_email ?>" class="form-control" disabled>
							</div>
						</div>
						<?php } ?>
						<?php } ?>
